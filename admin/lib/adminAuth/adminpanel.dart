import 'package:admin/AdminScreen/Studentlist.dart';
...
import 'package:admin/adminAuth/forgetpasseord.dart';
...
class Adminpanel extends StatefulWidget {
  ...
  @override
  State<Adminpanel> createState() => _LoginscreenState();
}

class _LoginscreenState extends State<Adminpanel> {
  bool error = false;
  ...
  gotohome(BuildContext context) {
    return Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Adminstudentlist()),
    );
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    custombutton.Add(
                      ...
                      width: 320,
                      callback: () {
                        email.text.toString() == "mushtaqjugnu04@gmail.com"|| email.text.toString() == "ishtiaqahmed1406@gmail.com"
                            ? login(
                              email.text.toString(),
